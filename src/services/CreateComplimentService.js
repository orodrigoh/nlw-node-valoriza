...
var CreateComplimentService = /** @class */ (function () {
    ...
    CreateComplimentService.prototype.execute = function (_a) {
        var tag_id = _a.tag_id, user_receiver = _a.user_receiver, user_sender = _a.user_sender, message = _a.message;
        return __awaiter(this, void 0, void 0, function () {
            var complimentRepositories, usersRepository, userReceiverExists, compliment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        complimentRepositories = typeorm_1.getCustomRepository(ComplimentsRepositories_1.ComplimentRepositories);
                        usersRepository = typeorm_1.getCustomRepository(UsersRepositories_1.UsersRepositories);
                        if (user_receiver === user_sender) {
                            throw new Error("Incorrect User Receiver");
                        }
                        return [4 /*yield*/, usersRepository.findOne(user_receiver)];
                    case 1:
                        userReceiverExists = _b.sent();
                        if (!userReceiverExists) {
                            throw new Error("User Receiver does not exists!");
                        }
                        compliment = complimentRepositories.create({
                            tag_id: tag_id,
