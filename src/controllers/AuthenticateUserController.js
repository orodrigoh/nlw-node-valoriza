...
var AuthenticateUserController = /** @class */ (function () {
    ...
    AuthenticateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, createToken, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, email = _a.email, password = _a.password;
                        createToken = new AuthenticateUserService_1.AuthenticateUserService();
                        return [4 /*yield*/, createToken.execute({ email: email, password: password })];
                    case 1:
                        token = _b.sent();
